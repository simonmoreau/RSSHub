...
// Dilbert Comic Strip
router.get('/dilbert', lazyloadRouteHandler('./routes/dilbert/strip'));
...
// Philippe Silberzahn
router.get('/philippesilberzahn', lazyloadRouteHandler('./routes/philippesilberzahn/home'));

// The Building Coder
router.get('/thebuildingcoder', lazyloadRouteHandler('./routes/thebuildingcoder/home'));

// Batirama
router.get('/batirama', lazyloadRouteHandler('./routes/batirama/home'));

// BonneGueule
router.get('/bonnegueule', lazyloadRouteHandler('./routes/bonnegueule/home'));

// Life of an Architect
router.get('/lifeofanarchitect', lazyloadRouteHandler('./routes/lifeofanarchitect/home'));

// Forge Communty Blog
router.get('/forge', lazyloadRouteHandler('./routes/forge/home'));

// Permanent Style
router.get('/permanent-style', lazyloadRouteHandler('./routes/permanentstyle/home'));

// Le blog du droit de l'urbanisme et de l'aménagement
router.get('/droiturbanismeetamenagement', lazyloadRouteHandler('./routes/droiturbanismeetamenagement/home'));

// Die, Workwear
router.get('/dieworkwear', lazyloadRouteHandler('./routes/dieworkwear/home'));

// ParametricMonkey
router.get('/parametricmonkey', lazyloadRouteHandler('./routes/parametricmonkey/home'));

// Håvard Vasshaug
router.get('/vasshaug', lazyloadRouteHandler('./routes/vasshaug/home'));

// archi-lab
router.get('/archi-lab', lazyloadRouteHandler('./routes/archi-lab/home'));

// buildllc.com
router.get('/buildllc', lazyloadRouteHandler('./routes/buildllc/home'));

// The Socialite Family
router.get('/socialitefamily', lazyloadRouteHandler('./routes/socialitefamily/home'));

// NEC PLURIBUS IMPAR
router.get('/necpluribusimpar', lazyloadRouteHandler('./routes/necpluribusimpar/home'));

// institutdeslibertes
router.get('/institutdeslibertes', lazyloadRouteHandler('./routes/institutdeslibertes/home'));
