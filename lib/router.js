...
// Dilbert Comic Strip
router.get('/dilbert', require('./routes/dilbert/strip'));
...
// Philippe Silberzahn
router.get('/philippesilberzahn', require('./routes/philippesilberzahn/home'));

// The Building Coder
router.get('/thebuildingcoder', require('./routes/thebuildingcoder/home'));

// Batirama
router.get('/batirama', require('./routes/batirama/home'));

// BonneGueule
router.get('/bonnegueule', require('./routes/bonnegueule/home'));

// Life of an Architect
router.get('/lifeofanarchitect', require('./routes/lifeofanarchitect/home'));

// Forge Communty Blog
router.get('/forge', require('./routes/forge/home'));

// Permanent Style
router.get('/permanent-style', require('./routes/permanentstyle/home'));

// Le blog du droit de l'urbanisme et de l'aménagement
router.get('/droiturbanismeetamenagement', require('./routes/droiturbanismeetamenagement/home'));

// Die, Workwear
router.get('/dieworkwear', require('./routes/dieworkwear/home'));

// ParametricMonkey
router.get('/parametricmonkey', require('./routes/parametricmonkey/home'));

// Håvard Vasshaug
router.get('/vasshaug', require('./routes/vasshaug/home'));

// archi-lab
router.get('/archi-lab', require('./routes/archi-lab/home'));

// buildllc.com
router.get('/buildllc', require('./routes/buildllc/home'));

// The Socialite Family
router.get('/socialitefamily', require('./routes/socialitefamily/home'));

// NEC PLURIBUS IMPAR
router.get('/necpluribusimpar', require('./routes/necpluribusimpar/home'));

// vinted
router.get('/vinted/:catalog/:brandid?', require('./routes/vinted/home'));

// institutdeslibertes
router.get('/institutdeslibertes', require('./routes/institutdeslibertes/home'));
